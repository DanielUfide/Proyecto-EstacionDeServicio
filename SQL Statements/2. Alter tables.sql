...
INSERT INTO FACTURA (ID_FACTURA, DETALLE, MONTO, ID_USUARIO,METODO_PAGO) VALUES (1,'PROYECTO 1',250,2,'PENDIENTE')
INSERT INTO FACTURA (ID_FACTURA, DETALLE, MONTO, ID_USUARIO,METODO_PAGO) VALUES (2,'PROYECTO 2',250,2,'PENDIENTE')
INSERT INTO FACTURA (ID_FACTURA, DETALLE, MONTO, ID_USUARIO,METODO_PAGO) VALUES (3,'PROYECTO 3',250,2,'PENDIENTE')


ALTER TABLE FACTURA ADD CANCELADO BIT; 

  CREATE OR ALTER PROCEDURE INFORMACION_FACTURAS_USUARIO (@ID_USUARIO INT)
	AS
	SELECT 
		F.ID_FACTURA, 
		F.DETALLE, 
